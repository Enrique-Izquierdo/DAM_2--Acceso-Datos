...
public class Vista {
	...
	//constructors
	/**Mètode: Vista
	 * Descripció: flama al métode initialize.
	...
	/**Mètode: initialize
	 * Descripció: inicialitza els objectes corresponents als elements que conformen la interface,
	 *  i assigna els valors que determinen la seua forma, etc.
	 * Paràmetres d'entrada: no 
	 * Paràmetres d'eixida:	no*/
