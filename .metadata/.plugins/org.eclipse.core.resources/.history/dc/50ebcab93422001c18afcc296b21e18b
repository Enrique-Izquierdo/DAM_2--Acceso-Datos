...
public class AE1_T1 {
	...
	private static void getInformacio(String rutaRelativaFitxer) {		
		try {
			...
			try {			
				...
				//Càlcul data última modificació.
	...
	/**
	 * Mètode crearFitxer(*pEntradaTeclat): sol·licita la ruta relativa del fitxer a crear 
	 * en el directori on es troba el projecte. Crea el fitxer(arxiu), informant per consola 
	 * de la finalització del procés. I, en cas de no ser possible crear ho, informa per consola 
	 * del motiu: el fitxer ja existeix, error per no assignació de variables a l'objecte, 
	 * error durant l'entrada/eixida de dades o, error per absència de permisos d'escriptura.
	 * @*param pEntradaTeclat: objecte amb la connexió per a l'entrada/eixida de dades.
	 */
	...
	public static void main(String[] args) {						
		...
		do {
			System.out.println("Activitats Avaluables 1 - Enrique Izquierdo Jiménez\n"
					+ "===================================================="
					+ "\n____OPCIONS DISPONIBLES____\n1 - Veure informació fitxer\n"
					+ "2 - Crear carpeta\n3 - Crear fitxer\n4 - Elimina\n5 - Renomena\n0 - EIXIR");		
			System.out.print("Seleccione una opció (del 0 al 5): ");
